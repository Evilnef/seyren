...
public class MongoMapper {
    ...
    public Alert alertFrom(DBObject dbo) {
        ...
        BigDecimal streak = getBigDecimal(dbo, "streak");
    ...
    private Map propertiesToMap(Subscription subscription) {
        ...
        map.put("hitsToNotify", subscription.getHitsToNotify().toPlainString());
    ...
    private Map propertiesToMap(Alert alert) {
        ...
        if (alert.getStreak() != null) {
            map.put("streak", alert.getStreak().toPlainString());
        }
