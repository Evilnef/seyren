...
public class SubscriptionTest {
    ...
    public void subscriptionShouldNotifyWhenTimeAndDateAreGood() {
        ...
        assertThat(sub.shouldNotify(dateTime("1030"), AlertType.ERROR, BigDecimal.ONE), is(true));
    }
    
    @Test
    public void subscriptionShouldNotNotifyAfterTime() {
        Subscription sub = new Subscription().withEnabled(true).withFromTime(localTime("1000")).withToTime(localTime("1100")).withSu(true);
        assertThat(sub.shouldNotify(dateTime("1200"), AlertType.ERROR, BigDecimal.ONE), is(false));
    }
    
    @Test
    public void subscriptionShouldNotNotifyBeforeTime() {
        Subscription sub = new Subscription().withEnabled(true).withFromTime(localTime("1000")).withToTime(localTime("1100")).withSu(true);
        assertThat(sub.shouldNotify(dateTime("0900"), AlertType.ERROR, BigDecimal.ONE), is(false));
    }
    
    @Test
    public void subscriptionShouldNotNotifyOnTheWrongDay() {
        Subscription sub = new Subscription().withEnabled(true);
        assertThat(sub.shouldNotify(dateTime("1015"), AlertType.ERROR, BigDecimal.ONE), is(false));
    }
    ...
    public void subscriptionShouldNotifyOfErrorWhenNotIgnoringErrorOrWarning() {
        Subscription sub = new Subscription()
                ...
                .withIgnoreOk(false)
                .withHitsToNotify(BigDecimal.ONE);
        assertThat(sub.shouldNotify(dateTime("1015"), AlertType.ERROR, BigDecimal.ONE), is(true));
    }
    ...
    public void subscriptionShouldNotifyOfWarningWhenNotIgnoringErrorOrWarning() {
        Subscription sub = new Subscription()
                ...
                .withIgnoreOk(false)
                .withHitsToNotify(BigDecimal.ONE);
        assertThat(sub.shouldNotify(dateTime("1015"), AlertType.WARN, BigDecimal.ONE), is(true));
    }
    ...
    public void subscriptionShouldNotNotifyOfWarningWhenIgnoringWarning() {
        Subscription sub = new Subscription()
                ...
                .withIgnoreOk(false)
                .withHitsToNotify(BigDecimal.ONE);
        assertThat(sub.shouldNotify(dateTime("1015"), AlertType.WARN, BigDecimal.ONE), is(false));
    }
    ...
    public void subscriptionShouldNotNotifyOfOkWhenIgnoringOk() {
        Subscription sub = new Subscription()
                ...
                .withIgnoreOk(true)
                .withHitsToNotify(BigDecimal.ONE);
        assertThat(sub.shouldNotify(dateTime("1015"), AlertType.OK, BigDecimal.ONE), is(false));
    }
    ...
    public void subscriptionShouldNotifyOfOkWhenNotIgnoringOk() {
        Subscription sub = new Subscription()
                ...
                .withIgnoreOk(false)
                .withHitsToNotify(BigDecimal.ONE);
        assertThat(sub.shouldNotify(dateTime("1015"), AlertType.OK, BigDecimal.ONE), is(true));
    }
