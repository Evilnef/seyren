...
public class CheckRunnerFactory {
    ...
    @Inject
    public CheckRunnerFactory(AlertsStore alertsStore, ChecksStore checksStore, TemplatesStore templatesStore, TargetChecker targetChecker, ValueChecker valueChecker,
    ...
    public CheckRunner create(Check check) {
        return new CheckRunner(check, alertsStore, checksStore, templatesStore,targetChecker, valueChecker, notificationServices);
    }

    public CheckRunner create(Check check, BigDecimal value) {
        return new CheckRunner(check, alertsStore, checksStore, templatesStore,new NoopTargetCheck(value), valueChecker, notificationServices);
    }
