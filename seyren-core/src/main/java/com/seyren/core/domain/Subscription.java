...
public class Subscription {
    ...
    private BigDecimal hitsToNotify;
    ...
    public BigDecimal getHitsToNotify() {
        return hitsToNotify;
    }

    public void setHitsToNotify(BigDecimal hitsToNotify) {
        this.hitsToNotify = hitsToNotify;
    }

    public Subscription withHitsToNotify(BigDecimal hitsBeforeNotify) {
        setHitsToNotify(hitsBeforeNotify);
        return this;
    }
    ...
    public boolean shouldNotify(DateTime time, AlertType alertType, BigDecimal streak) {
        if (!isEnabled()) {
            return false;
        }
